...
In this calculation, I place two point charges to approximate the carboxylate
groups. Each point charge is placed at coordinates averaging the positions of
the oxygens in a carboxylate group.
...
mc.fix_spin(ss=0)
mc.natorb = True
mc.chkfile = "_chk/pp_dianion_pt_chg_dz_cas_4e_4o.chk"
...
#
mc.analyze()
molden.from_mcscf(mc, "_molden/pp_dianion_pt_chg_dz_cas.molden")
molden.from_mo(mol, "_molden/pp_dianion_pt_chg_dz_cas_alt.molden", mc.mo_coeff)
